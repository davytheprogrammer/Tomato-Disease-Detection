"""
Django settings for tomato_disease project.
"""
import os
...
ALLOWED_HOSTS = config('ALLOWED_HOSTS', default='localhost,127.0.0.1', cast=lambda v: [s.strip() for s in v.split(',') if s])
...
ROOT_URLCONF = 'tomato_disease.urls'
...
WSGI_APPLICATION = 'tomato_disease.wsgi.application'
...
# Model file path
MODEL_PATH = config('MODEL_PATH', default=str(BASE_DIR.parent.parent / 'models' / 'best_mobilenet_finetuned.keras'))
